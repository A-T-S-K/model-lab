const concepts: Record<string, [string, string, string, string]> = {
  attentionOutput: ['Combined heads', 'concatenate head outputs in head order', 'model/microgpt.ts', 'forward'],
  ...
  targetProbability: ['Target probability', 'probabilities[target ID]', 'model/microgpt.ts', 'loss'],
  changedParameters: ['Changed parameters', 'parameter.data = after', 'model/training.ts', 'adamStep'],
